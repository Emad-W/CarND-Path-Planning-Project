    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
            ...
            for ( int i = 0; i < sensor_fusion.size(); i++ ) {
                ...
                if ( check_car_d > 0 && check_car_d < 4 ) {
                  ...
                  check_car_lane = 2;
                    ...
                    // data is not valid or car is not in a specific lane ( on a transition boundry )
                  continue;
                  std::cout << check_car_lane << std::endl;
                }
                ...
                if ( check_car_lane == lane ) {
                  ...
                  too_close |= check_car_s - car_s < 15;
                } else if ( check_car_lane < lane) {
                  // check car on the left
                  car_left |= car_s - 30 < check_car_s && car_s + 30 > check_car_s;
                } else if ( check_car_lane > lane ) {
                  // check car on the right
                  car_right |= car_s - 30 < check_car_s && car_s + 30 > check_car_s;
                }
              std::cout << car_left << car_ahead << car_right << std::endl;
            }
            ...
            const double SMOOTH_ACC = .112;
            if ( car_ahead ) { // Car ahead too close
              if ( !car_left && lane > 0 ) {
            ...
            // Coordinates shift and transformation.
